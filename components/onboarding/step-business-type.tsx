        ...
        {TYPES.map((type) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative flex flex-col items-center justify-center gap-4 rounded-2xl border-2 p-6 text-center transition-all duration-200 group cursor-pointer h-[220px]",
                isSelected
