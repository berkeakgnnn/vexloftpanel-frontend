  ...
  return (
    <div className="md:hidden flex items-center justify-between px-4 py-3 border-b bg-white sticky top-0 z-40">
      <Link href="/dashboard" className="flex items-center gap-2">
        {/* Indigo accent mark matching brand */}
        <span className="inline-block w-1 h-4 rounded-full bg-indigo-600 shrink-0" />
        ...
        <SheetContent side="left" className="w-[280px] p-0">
          <div className="px-5 py-5 border-b border-indigo-100">
            <div className="flex items-center gap-2.5">
              <span className="inline-block w-1 h-5 rounded-full bg-indigo-600 shrink-0" />
